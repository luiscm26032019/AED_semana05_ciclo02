...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
    	...
    	imprimir("Cantidad de notas > 15\t\t  : " + an.cantNotasMayoresA15());
    	imprimir("Posición de la primera nota >= 13 : " + an.posPrimeraNotaAprobatoria());
    	imprimir("Posición de la penúltima nota < 13: " + an.posPenultimaNotaDesaprobatoria());
	}
